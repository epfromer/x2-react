// import { EmailXferedDatum, EmailSentStat } from './types'
...
export const getEmailSentStats = (state: any) => {
...
export function getEmailSenders(state: any) {
...
export function getEmailReceivers(state: any) {
  // const data: Array<EmailXferedDatum> = []
  // if (state.contacts) {
  //   state.contacts.forEach((contact) => {
  //     if (contact.senderTotal) {
